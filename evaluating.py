...
class Metrics(object):
    ...
    def cal_precision(self):
        ...
        for ent in self.ent_tags:
            if ent in self.predict_ent_counter and self.predict_ent_counter[ent] != 0:
                precision_scores[ent] = self.correct_tags_number.get(ent, 0) / self.predict_ent_counter[ent]
